...
public class modul4 extends AppCompatActivity {
    ...
    public void order(View v){
        Intent intent = new Intent(modul4.this, pembayaran.class);
    ...
    public void dialphone(View w){
        Intent dialphoneintent = new Intent(Intent.ACTION_DIAL);
        dialphoneintent.setData(Uri.parse("tel:087857022080"));
        startActivity(dialphoneintent);
    }

    public void detailmenu(View x){
        Intent detailmenuintent = new Intent(modul4.this,detailmenu_modul4.class);
